    ...
    <div class="w-full sm:max-w-md p-5 mx-auto">
      ...
      <form>
        <div class="mb-4">
          ...
          <input id="nickname" type="text" name="nickname" class="bg-yellow-50 py-2 px-3 border border-gray-300 focus:border-red-300 focus:outline-none focus:ring focus:ring-yellow-300 focus:ring-opacity-50 rounded-md shadow-sm disabled:bg-gray-100 mt-1 block w-full" />
        </div>
        <div class="mb-4">
          <label class="block mb-1 text-gray-200" for="password">Пароль</label>
          <input id="password" type="password" name="password" class="bg-yellow-50 py-2 px-3 border border-gray-300 focus:border-red-300 focus:outline-none focus:ring focus:ring-yellow-300 focus:ring-opacity-50 rounded-md shadow-sm disabled:bg-gray-100 mt-1 block w-full" />
        </div>
        <div class="mt-6">
          <router-link to="/">
